...
import { IonContent, IonThumbnail, IonItem, IonLabel, IonGrid, IonRow, IonCol, IonIcon, IonImg } from '@ionic/react';
                    ...
                    <IonRow>
                        <IonCol size="1">
                            <IonThumbnail item-start>
                                ...
                                {/* <IonIcon name="pin" item-start color="primary"></IonIcon> */}
                            </IonThumbnail>
                        </IonCol>
                        <IonCol size="2">
                            <IonLabel>
